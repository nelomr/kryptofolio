...
- **🔄 Materializador de Portafolio Sincronizado y Divisa Dinámica:** Recálculo FIFO bajo demanda, coordinado por `FifoChainFreshnessService`, que reconstruye seis relaciones materializadas de DuckDB y reconcilia el libro contable de SQLite a partir de ellas como un único proceso, adaptándose dinámicamente a la divisa base configurada por el usuario.
