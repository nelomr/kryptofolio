...
export const en: I18nDictionary = {
  ...
  'portfolio.metrics_tabs.performance.desc': 'Liquidated portfolio value vs cost basis ({cost}). Blue line = equity, dotted gray = cost basis.',
  'portfolio.metrics_tabs.performance.stats.return': 'Return {range}',
  'portfolio.metrics_tabs.performance.stats.return_desc': 'Absolute profit or loss (in Fiat) generated over the selected period.',
  'portfolio.metrics_tabs.performance.stats.vs_cost': '% vs Cost',
  'portfolio.metrics_tabs.performance.stats.vs_cost_desc': 'Percentage yield compared to the initial investment or cost basis.',
  'portfolio.metrics_tabs.performance.stats.volatility': 'Volatility',
  'portfolio.metrics_tabs.performance.stats.volatility_desc': 'Dispersion of returns (standard deviation). Higher % means greater risk or fluctuation.',
  ...
  'metrics.assets_kicker_desc': 'Total number of distinct crypto assets making up your current portfolio.',
  'metrics.hhi_kicker': 'HHI',
  'metrics.hhi_kicker_desc': 'Herfindahl-Hirschman Index. Measures concentration. >2500 indicates high concentration in few assets.',
  'metrics.volatility.kicker': 'Volatility Heatmap',
  'metrics.volatility.title': 'Daily returns · 15 weeks',
  'metrics.volatility.desc': 'Each cell is a day. Green = positive return, red = loss, intensity = magnitude.',
  ...
  'metrics.volatility.stats.best_day_desc': 'The highest percentage gain recorded in a single day within the heatmap.',
  'metrics.volatility.stats.worst_day': 'Worst Day',
  'metrics.volatility.stats.worst_day_desc': 'The largest percentage drop recorded in a single day.',
  'metrics.volatility.stats.bullish_days': 'Bullish Days',
  'metrics.volatility.stats.bullish_days_desc': 'Proportion of days that closed with a positive return out of the total days shown.',
