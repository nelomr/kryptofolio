...
export const es: I18nDictionary = {
  ...
  'portfolio.metrics_tabs.performance.stats.return_desc': 'Beneficio o pérdida absoluta (en Fiat) generada en el período seleccionado.',
  'portfolio.metrics_tabs.performance.stats.vs_cost': '% s/coste',
  'portfolio.metrics_tabs.performance.stats.vs_cost_desc': 'Rendimiento porcentual frente a la inversión inicial o coste base.',
  'portfolio.metrics_tabs.performance.stats.volatility': 'Volatilidad',
  'portfolio.metrics_tabs.performance.stats.volatility_desc': 'Dispersión de los retornos (desviación estándar). A mayor %, mayor riesgo o fluctuación.',
  ...
  'metrics.assets_kicker_desc': 'Número total de criptoactivos distintos que conforman tu cartera actual.',
  'metrics.hhi_kicker': 'HHI',
  'metrics.hhi_kicker_desc': 'Herfindahl-Hirschman Index. Mide la concentración. >2500 indica alta concentración en pocos activos.',
  'metrics.volatility.kicker': 'Heatmap de Volatilidad',
  'metrics.volatility.title': 'Retornos diarios · 15 semanas',
  'metrics.volatility.desc': 'Cada celda es un día. Verde = retorno positivo, rojo = pérdida, intensidad = magnitud.',
  ...
  'metrics.volatility.stats.best_day_desc': 'La ganancia porcentual más alta en un solo día dentro del mapa de calor.',
  'metrics.volatility.stats.worst_day': 'Peor día',
  'metrics.volatility.stats.worst_day_desc': 'La mayor caída porcentual registrada en un solo día.',
  'metrics.volatility.stats.bullish_days': 'Días Alcistas',
  'metrics.volatility.stats.bullish_days_desc': 'Proporción de días que cerraron en positivo frente al total de días mostrados.',
