...
function makeMockLedger(): Mocked<ILedgerPort> {
  return {
    ...
    reconcileTaxLots: vi.fn(),
    reconcileLotHistoryEvents: vi.fn(),
    reconcileCustodyEntries: vi.fn(),
    getCustodyEntries: vi.fn(),
    getManualPriceOverrides: vi.fn(),
    setManualPriceOverride: vi.fn(),
    removeManualPriceOverride: vi.fn(),
    getTransferDestinationOverrides: vi.fn(),
    setTransferDestinationOverride: vi.fn(),
    removeTransferDestinationOverride: vi.fn(),
    getAccounts: vi.fn(),
